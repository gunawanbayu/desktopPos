...
public class BarangView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 310, 290, 40));
    ...
    setDefaultCloseOperation(BarangView.DISPOSE_ON_CLOSE);
    }
    public static void getData(){
    tableKategori.setModel(new javax.swing.table.DefaultTableModel(
            Barang.listData(),
            new String [] {
                "Kode Barang", "Nama Barang","Harga Barang","Kode Barang","Kategori Barang"}
        ){
