...
//        JOptionPane.showMessageDialog(null, );
        inputName.setText(BarangView.inputNameEdit);
        inputHarga.setText(BarangView.inputHargaEdit);
        ...
        String listDataSelected = null;
        for (int i = 0; i < listData.length; i++) {
            listSelectKategori[i] = listData[i][1];
            if(listData[i][0] ==  BarangView.inputKodeKategoriEdit){
                listDataSelected = listData[i][1];
                selectKategori.getModel().setSelectedItem(listData[i][1]);
            }
        }
